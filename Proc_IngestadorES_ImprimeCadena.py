...
#    es = elasticsearch.Elasticsearch([{'host': 'locahost', 'port': 9200}])
#except:
...
#	archiErr.write("Error Borrado ElasticSearch "+"\n")     
#	archiErr.close()
#	archiBulk.close()
#	#sys.exit()
...
#except:
#        print("Error creando 'Ciclope' index... ElasticSearch ")   
#        archiErr.write("Error creando 'Ciclope' index...ElasticSearch "+"\n")     
#        archiErr.close()
#        archiBulk.close()
#        sys.exit()
